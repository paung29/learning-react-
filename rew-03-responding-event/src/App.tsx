    ...
    <>
      ...
      <main className='mt-4 container'>
        <Routes>
          ...
          <Route path='/passing-hand' element={<PassingHandler/>} />
          <Route path='/naming-hand' element={<NamingEventHandler/>} />
        </Routes>
      </main>
    </>
  )
    ...
    <nav className='navbar navbar-expand navbar-dark bg-primary'>
      <div className="container">
        ...
        <ul className='navbar-nav'>
          ...
          <NavItem path='/passing-hand' name='Passing Handler' />
          <NavItem path='naming-hand' name='Naming Handler' />
        </ul>
      </div>
    </nav>
  )
