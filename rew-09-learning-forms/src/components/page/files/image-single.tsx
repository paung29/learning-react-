...
export default function ImageSingle() {
    ...
    const {reset, handleSubmit, setValue, watch, formState : {isValid}} = useForm<FormType>({
    ...
    return(
        <form onSubmit={handleSubmit(saveAction)}>
            ...
            <input type="file" onChange={changeFile} ref={fileInputRef} className="hidden" />
            ...
            <div>
                ...
                <Button onClick={clearAction} disabled={!isValid} className="ms-2" type="button">
                    <Trash2 /> Clear
                </Button>
